...
> **Licensed software.** Read [LICENSE.md](LICENSE.md) before use. One purchase
> lets you build unlimited projects of your own; it does not let you redistribute
> or resell the source. Please don't share your repository access.
...
Licensed under [LICENSE.md](LICENSE.md). Copyright © 2026 Irasubiza Divin Prince.
